...
Section hprop.
  ...
  Lemma list_eq_trans : forall X (l1 l2 l3 : list X), l1 ≡ l2 -> l2 ≡ l3 -> l1 ≡ l3.
  Proof.
    intros. split; intro. apply H0. apply H. auto.
  ...
  Proof.
    ...
    eapply P4. eapply P1. eapply P. apply in_or_app. right. destruct (P2 t'). eapply H0. apply in_eq.
    apply P3. apply (in_eq t'); eauto. reflexivity. intros. apply in_or_app. left; auto.
  ...
  Proof.
    induction h; auto.
    intros. destruct (H a). destruct H0. apply in_eq.
  Qed.

  Global Instance affine_heap_empty : Affine (heap_ctx ∅).
  Proof.
    split. intro. MonPred.unseal. repeat red. intros. apply eq_list_nil. apply H.
  Qed.

  Lemma init_heap : ⊢ heap_ctx ∅.
  Proof.
    split. MonPred.unseal. repeat red. intros. inversion H. subst. split; auto.
  Qed.
  ...
  Proof.
    ...
    + intro. apply P in H0. apply P2. apply in_app_or in H0.
      destruct H0; auto. inv H0.
    + intro. apply P. apply in_or_app. right. apply P2. auto.
  Qed.
